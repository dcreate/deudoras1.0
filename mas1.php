...
if(isset($_POST['enviar']))
{
	if(!empty($_POST['fecha']))
	{
		...
		$deuda=$_POST['opcion'];
		conectar();
		$bus=mysql_query("SELECT SUM(agrego) totales FROM adeudos where fecha_op='$fecha' AND estado='$deuda'") or die ("error: ".mysql_error());
		desconectar();
...
<body>
	...
	<section id="contenido">
					<article class="item">
						...
						echo "<div class='tutol'> DIA: ".$fecha."</div>";
